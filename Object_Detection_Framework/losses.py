...
import backend
import numpy as np
from commons import binary_crossentropy
...
def negative_weighted_ce_loss():
    """ Create a functor for computing the negative_weighted_sigmoidloss.
    ...
    return _negative_weighted_ce_loss
