...
EfficientNetB0_ = inject_keras_modules(EfficientNetB0)
EfficientNetB1_ = inject_keras_modules(EfficientNetB1)
EfficientNetB2_ = inject_keras_modules(EfficientNetB2)
EfficientNetB3_ = inject_keras_modules(EfficientNetB3)
EfficientNetB4_ = inject_keras_modules(EfficientNetB4)
EfficientNetB5_ = inject_keras_modules(EfficientNetB5)
EfficientNetB6_ = inject_keras_modules(EfficientNetB6)
EfficientNetB7_ = inject_keras_modules(EfficientNetB7)
